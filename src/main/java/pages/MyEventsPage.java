...
public class MyEventsPage extends BasePage {
  ...
  private final By EVENT_WEB_APP_TAB = By.xpath("//*[@class='rs-sidebar-nav']//*[contains(text(),'Web App')]");
  private final By EDIT_EVENT_TAB = By.xpath("//*[@id='rs-wrapper']/aside //*[contains(text(),'Edit')]");
